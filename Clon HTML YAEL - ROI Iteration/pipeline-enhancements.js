(() => {
  ...
  function renderStage() {
    ...
    if(!document.querySelector('#statusMapping')){
      const mapping=document.createElement('div');mapping.id='statusMapping';mapping.className='status-mapping';
      mapping.innerHTML=`<b>How detailed statuses map to these stages:</b> <span class="tag">Identified</span><span class="tag">Under Review</span><span class="tag">Considering</span><span class="tag">Approved to Pursue</span> → <b>Qualified</b> · <span class="tag">Proposal in Preparation</span> → <b>Proposal</b> · <span class="tag">Submitted</span> → <b>Submitted</b> · <span class="tag">Won</span><span class="tag">Not Selected</span><span class="tag">Not Pursuing</span> → <b>History</b>. Forecast items live in the <b>Future opportunities watchlist</b> on Today, not in this pipeline.`;
      document.querySelector('#pipelineMetrics').after(mapping);
    }
